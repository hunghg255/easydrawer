...
export class Viewport {
  ...
  public static roundScaleRatio(scaleRatio: number, roundAmount = 1): number {
  ...
  public computeZoomToTransform(
    ...
    if (isNaN(toMakeVisible.size.magnitude())) {
      throw new TypeError(`${toMakeVisible.toString()} rectangle has NaN size! Cannot zoom to!`);
    }
