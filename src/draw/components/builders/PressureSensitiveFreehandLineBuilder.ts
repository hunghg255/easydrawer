import {
  ...
  type PathCommand,
  PathCommandType,
  type QuadraticBezierPathCommand,
...
import { StrokeSmoother, type Curve } from '../util/StrokeSmoother';
...
export default class PressureSensitiveFreehandLineBuilder implements ComponentBuilder {
  ...
  private previewCurrentPath(extendWithLatest = true): RenderablePathSpec | null {
