...
import adjustExportedSVGSize, { type SVGSizingOptions } from './adjustExportedSVGSize';
import SVGRenderer from '../../rendering/renderers/SVGRenderer';
import { svgLoaderAutoresizeClassName } from '../../SVGLoader/SVGLoader';
import type EditorImage from '../EditorImage';
import { type PreRenderComponentCallback } from '../EditorImage';
...
function toSVGInternal (image: EditorImage,
...
export function editorImageToSVGSync (image: EditorImage, options: SVGExportOptions) {
...
export function editorImageToSVGAsync (image: EditorImage,
