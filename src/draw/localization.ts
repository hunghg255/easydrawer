import { type CommandLocalization, defaultCommandLocalization } from './commands/localization';
import {
  defaultComponentLocalization,
  type ImageComponentLocalization,
} from './components/localization';
import {
  defaultTextRendererLocalization,
  type TextRendererLocalization,
} from './rendering/localization';
import { defaultToolbarLocalization, type ToolbarLocalization } from './toolbar/localization';
import { defaultToolLocalization, type ToolLocalization } from './tools/localization';
