 ...
 */
function createHelpPage (helpItems: HelpRecord[],
  ...
  const updateClonedElementStates = () => {
    ...
    for (const [index, clonedElementContainer] of clonedElementContainers.entries()) {
      for (const { container, bbox: containerBBox } of clonedElementContainer) {
