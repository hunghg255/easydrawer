...
import { type ToolMenu, type WidgetContentLayoutManager } from './layout/types';
...
export default abstract class BaseWidget {
  ...
  #disabledDueToReadOnlyEditor = false;
  ...
  public constructor(
    ...
    this.container.classList.add(
      ...
      `${toolbarCSSPrefix}internalWidgetId--${id.replace(/\W/g, '-')}`,
    );
  ...
  protected setUpButtonEventListeners(button: HTMLElement) {
    ...
    button.addEventListener('keyup', (htmlEvent) => {
