import { Mat33, Vec2 } from '~/math';

import fileToImages from './fileToImages';
import { ImageWrapper } from './ImageWrapper';
import Erase from '../../../commands/Erase';
import { type Command } from '../../../commands/lib';
...
import makeSnappedList, {
  type SnappedListControl,
  type SnappedListItem,
...
export default class InsertImageWidget extends BaseWidget {
  ...
  private updateInputs() {
    ...
    const selectedObjects = selectionTools.flatMap((tool) => tool.getSelectedObjects());
