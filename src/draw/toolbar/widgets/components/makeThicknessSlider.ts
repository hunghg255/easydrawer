import { toRoundedString } from '~/math';
...
function makeThicknessSlider (context: ToolbarContext, onChange: (value: number) => void) {
  ...
  thicknessInput.addEventListener('input', () => {
    onChange(thicknessInputFn(Number.parseFloat(thicknessInput.value)));
  });
