import { type ToolMenu, type WidgetContentLayoutManager, type ToolMenuParent } from './types';
import EventDispatcher, { type DispatcherEventListener } from '../../../EventDispatcher';
import { EditorEventType, type EditorNotifier } from '../../../types';
...
export default class DropdownLayoutManager implements WidgetContentLayoutManager {
  private notifier: NotifierType;
  private dropdowns = new Set<Dropdown>();
