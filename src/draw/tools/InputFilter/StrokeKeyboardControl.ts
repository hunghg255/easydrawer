...
import { type InputEvt, InputEvtType, type PointerEvt } from '../../inputEvents';
import type Pointer from '../../Pointer';
import type KeyboardShortcutManager from '../../shortcuts/KeyboardShortcutManager';
...
export default class StrokeKeyboardControl extends InputMapper {
  ...
  private angleLockEnabled = false;
