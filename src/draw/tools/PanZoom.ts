...
import { type KeyPressEvent, type PointerEvt, type WheelEvt } from '../inputEvents';
...
export default class PanZoom extends BaseTool {
  ...
  private lastPointerDownTimestamp = 0;

  private initialTouchAngle = 0;
  private initialViewportRotation = 0;
  private initialViewportScale = 0;
  ...
  private updateTransform(transformUpdate: Mat33, announce = false) {
