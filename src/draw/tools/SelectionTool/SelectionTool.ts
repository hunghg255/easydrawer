...
import type SelectionBuilder from './SelectionBuilders/SelectionBuilder';
...
export default class SelectionTool extends BaseTool {
  ...
  private selectionBoxHandlingEvt = false;
  ...
  private hasUnfinalizedTransformFromKeyPress = false;
