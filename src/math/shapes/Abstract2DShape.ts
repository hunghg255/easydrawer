...
export abstract class Abstract2DShape {
  ...
  /**
	 ...
	 * for this shape.
	 */
  public abstract signedDistance(point: IVec2): number;
  ...
  /**
	 ...
	 */
  public abstract intersectsLineSegment(lineSegment: LineSegment2): IVec2[];
  ...
  /**
	 ...
	 */
  public containsPoint(point: IVec2, epsilon: number = Abstract2DShape.smallValue): boolean {
